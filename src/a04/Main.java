...
public class Main {
        ...
        cuenta.mostrar();
            ...
            System.out.println("Tu banco es: " + CuentaCorriente.getBanco());
            
            Scanner teclado = new Scanner(System.in);
            
            System.out.println("Pon el nuevo nombre de banco: ");
            String nuevoBanco = teclado.nextLine();
            
            CuentaCorriente.setBanco(nuevoBanco);
            
            System.out.println("El banco ahora es: " + CuentaCorriente.getBanco());
    }
}
